  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Real-time analytics dashboard for Arc Network testnet" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><text y='.9em' font-size='90'>⚡</text></svg>" />
      </Head>

      <div className="min-h-screen bg-[#5a8a7a]">
        <Header onRefresh={refresh} loading={loading} onRpcChange={handleRpcChange} />
        
        <main className="pt-28 pb-16">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="mb-12">
              <SectionLabel>Arc Analytics</SectionLabel>
              <h1 className="arc-heading text-5xl mt-3">
                Testnet Analytics
              </h1>
